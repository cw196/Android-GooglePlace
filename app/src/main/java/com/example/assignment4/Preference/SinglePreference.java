package com.example.assignment4.Preference;
...
import com.example.assignment4.Fragments.SettingsFragment;
import com.example.assignment4.R;

public class SinglePreference extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_single_preference, menu);
        return true;
